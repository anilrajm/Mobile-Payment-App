...
import 'package:recharge_app_mega/models/ledger_model.dart';
import 'package:recharge_app_mega/models/load_wallet_model.dart';
import 'package:recharge_app_mega/models/login_model.dart';
import 'package:recharge_app_mega/models/payment_model.dart';
...
import 'package:recharge_app_mega/utils/constants.dart';
  ...
  Future<Login> loginRequest(
    ...
    try {
      var headers = {
        ...
        'Cookie':
            'ci_session=a%3A5%3A%7Bs%3A10%3A%22session_id%22%3Bs%3A32%3A%2267032554dceb978049a437d82a3ce12a%22%3Bs%3A10%3A%22ip_address%22%3Bs%3A13%3A%2242.104.152.54%22%3Bs%3A10%3A%22user_agent%22%3Bs%3A21%3A%22PostmanRuntime%2F7.30.0%22%3Bs%3A13%3A%22last_activity%22%3Bi%3A1674731914%3Bs%3A9%3A%22user_data%22%3Bs%3A0%3A%22%22%3B%7Db37cd65240443cd800c8839192b6cd5f'
      };
  ...
  Future<BusinessType> fetchBusinessTypes({
    ...
    try {
      ...
      request.body = json.encode({
        ...
        "request": {"data_type": "BUSINESS_TYPE", "data_sub_type": "RETAIL"}
      });
      request.headers.addAll(headers);
      ...
      if (response.statusCode == 200) {
        var data = await response.stream.bytesToString();
        businessType = businessTypeFromJson(data);
      } else {
        if (kDebugMode) {
          print(response.reasonPhrase);
        }
